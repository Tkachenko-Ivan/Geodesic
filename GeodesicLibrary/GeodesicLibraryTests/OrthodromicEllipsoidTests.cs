...
{
    /// <summary>
    /// Тестируется решение прямой и обратной геодезических задач на геоиде. 
    /// Для тестирования правильности отпределения азимута тестируется решения для всех сторон света
    /// </summary>
    /// <remarks>
